...
branch_alarm_channels_out = [32, 64, 128, 256]
branch_alarm_cnn_kernel_sizes = [(5, 5), (3, 5), (3, 3), (3, 3)]
branch_alarm_cnn_strides = [(1, 1), (1, 2), (2, 2), (2, 2)]
branch_alarm_cnn_paddings = [(0, 0), (0, 1), (0, 1), (0, 0)]
branch_alarm_cnn_activations = [functional.leaky_relu, functional.leaky_relu, functional.leaky_relu, functional.leaky_relu]

branch_alarm_pool_kernels = [(5, 5), (5, 5), (5, 5), (5, 5)]
branch_alarm_pool_strides = [(1, 2), (2, 2), (2, 2), (2, 3)]
branch_alarm_pool_paddings = [(0, 1), (1, 1), (0, 1), (0, 2)]
...
branch_vehicle_channels_out = [32, 64, 128, 256]
branch_vehicle_cnn_kernel_sizes = [(5, 5), (3, 5), (3, 3), (3, 3)]
branch_vehicle_cnn_strides = [(1, 1), (1, 2), (2, 2), (2, 2)]
branch_vehicle_cnn_paddings = [(0, 0), (0, 1), (0, 1), (0, 0)]
branch_vehicle_cnn_activations = [functional.leaky_relu, functional.leaky_relu, functional.leaky_relu, functional.leaky_relu]

branch_vehicle_pool_kernels = [(5, 5), (5, 5), (5, 5), (5, 5)]
branch_vehicle_pool_strides = [(1, 2), (2, 2), (2, 2), (2, 3)]
branch_vehicle_pool_paddings = [(0, 1), (1, 1), (0, 1), (0, 2)]
