...
branch_alarm_cnn_activations = [functional.relu, functional.relu, functional.relu]
...
branch_vehicle_cnn_activations = [functional.relu, functional.relu, functional.relu]
